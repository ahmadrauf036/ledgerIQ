...
const getPostedLinesUpTo = async (companyId: string, asOfDate: string) => {
...
const getPostedLinesBetween = async (
    companyId: string,
    startDate: string,
    endDate: string,
) => {
...
export const getBalanceSheet = async (companyId: string, asOfDate: string) => {
    ...
    const assetMap = new Map<
        string,
        { account_id: string; code: string; name: string; amount: number }
    >();
