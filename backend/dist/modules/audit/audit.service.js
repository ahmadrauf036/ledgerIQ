...
exports.getFilterOptions = exports.getRecordHistory = exports.getAuditLogs = exports.logAction = void 0;
...
const getAuditLogs = async (query) => {
    ...
    let baseQuery = supabase_1.supabaseAdmin
        .from("audit_logs")
        .select("*", { count: "exact" })
...
const getRecordHistory = async (tableName, recordId) => {
